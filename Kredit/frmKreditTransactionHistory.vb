Public Class frmKreditTransactionHistory
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmKreditTransactionHistory))
        ...
        Me.dtpDateEnd.Location = New System.Drawing.Point(320, 92)
        ...
        Me.dtpDateStart.Location = New System.Drawing.Point(128, 92)
        ...
        Me.lblName.Location = New System.Drawing.Point(248, 58)
        ...
        Me.Label71.Location = New System.Drawing.Point(37, 58)
        ...
        Me.txtMemberId.Location = New System.Drawing.Point(128, 56)
        ...
        Me.Name = "frmKreditTransactionHistory"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Review History Loan Transaction"
...
#End Region
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        Dim adoDS As DataSet
        Dim dtEndValue As Date = New Date(1901, 1, 1)

        Try
            If Me.lblName.Text <> "" Then
                'Get Data
                If Me.dtpDateEnd.Checked Then
                    adoDS = svcLoan.GetLoanTransactionHistory(Me.txtMemberId.Text.Trim, Me.dtpDateStart.Value, dtpDateEnd.Value, APP_ID)
                Else
                    adoDS = svcLoan.GetLoanTransactionHistory(Me.txtMemberId.Text.Trim, Me.dtpDateStart.Value, dtEndValue, APP_ID)
                End If
...
#Region "UnUsed Functions"
    'Private Sub txtLoanId_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    Dim svcLoan As New Loan.svcLoan
    '    Dim adoDS As DataSet
    ...
    '    End Try
    'End Sub
    'Private Sub txtLoanId_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
