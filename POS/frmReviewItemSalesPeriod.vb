Public Class frmReviewItemSalesPeriod
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmReviewItemSalesPeriod))
        ...
        Me.rbKonOnly.Location = New System.Drawing.Point(381, 79)
        Me.rbKonOnly.Name = "rbKonOnly"
        Me.rbKonOnly.TabIndex = 71
        ...
        Me.rbAllItem.Location = New System.Drawing.Point(269, 79)
        Me.rbAllItem.Name = "rbAllItem"
        Me.rbAllItem.TabIndex = 70
        ...
        Me.rbNonKon.Location = New System.Drawing.Point(493, 79)
        Me.rbNonKon.Name = "rbNonKon"
        Me.rbNonKon.TabIndex = 69
        ...
        Me.dtpEnd.Location = New System.Drawing.Point(264, 51)
        Me.dtpEnd.Name = "dtpEnd"
        Me.dtpEnd.ShowCheckBox = True
        Me.dtpEnd.Size = New System.Drawing.Size(136, 21)
        ...
        'btnSelect
        '
        Me.btnSelect.Location = New System.Drawing.Point(536, 49)
        ...
        Me.Label1.Text = "Select sales review period then click on the select button to view item informati" & _
        "on."
        ...
        Me.GroupBox2.Text = "Item Sales Information"
        '
        'lvwList
        '
        Me.lvwList.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(255, Byte), CType(192, Byte))
        Me.lvwList.Columns.AddRange(New System.Windows.Forms.ColumnHeader() {Me.ColumnHeader5, Me.ColumnHeader1, Me.ColumnHeader2, Me.ColumnHeader4, Me.ColumnHeader3})
        ...
        Me.Name = "frmReviewItemSalesPeriod"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Review Item Sales Per Period"
...
#End Region
    ...
    Private Sub frmRetailAverage_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        lvwList.Items.Clear()
        dtpStart.Value = Today
        'debug only
        dtpStart.Value = #6/2/2004#
        'dtpEnd.Value = #6/3/2004#
        'end debug
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        Try
            ...
            If Me.rbAllItem.Checked Then
                adoDS = svcPos.GetItemSalesPerPeriod(txtItemCode.Text.Trim, dtpStart.Value, dtpEnd.Value, 0, APP_ID)
            ElseIf Me.rbKonOnly.Checked Then
                adoDS = svcPos.GetItemSalesPerPeriod(txtItemCode.Text.Trim, dtpStart.Value, dtpEnd.Value, 1, APP_ID)
            Else
                adoDS = svcPos.GetItemSalesPerPeriod(txtItemCode.Text.Trim, dtpStart.Value, dtpEnd.Value, 2, APP_ID)
            End If
    ...
    Private Sub Generate_Report1(ByVal adoDS As DataSet)
        ...
        Try
            ...
            strTemplate = Application.StartupPath & "\Reports\POS_ITEM_SALES_PERPERIOD.xls"
            ...
            xlWs.Cells(4, 3) = Format(dtpEnd.Value, "ddd, dd MMM yyyy")
            ...
            For Each adoRow In adoDS.Tables(0).Rows
                ...
                xlWs.Cells(rowCount, 5) = adoRow!ITEM_QTY
                xlWs.Cells(rowCount, 6) = adoRow!GROSS_PRICE
                xlWs.Cells(rowCount, 7) = adoRow!SELL_PRICE
                xlWs.Cells(rowCount, 8) = CInt(adoRow!ITEM_QTY) * CDbl(adoRow!GROSS_PRICE)
                xlWs.Cells(rowCount, 9) = CInt(adoRow!ITEM_QTY) * CDbl(adoRow!SELL_PRICE)
                rowCount += 1
                intCount += 1
            Next
