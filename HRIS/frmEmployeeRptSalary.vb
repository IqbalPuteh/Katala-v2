Public Class frmEmployeeRptSalary
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmEmployeeRptSalary))
        ...
        Me.chkHistory.Location = New System.Drawing.Point(448, 88)
        ...
        Me.Name = "frmEmployeeRptSalary"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Employee Salary Information - Report"
...
#End Region
        ...
        Try
            ...
            If rbtEach.Checked Then
                ...
                If chkHistory.Checked Then
                    adoDS = svcHRIS.GetRPTEmpSalary(txtEmployeeId.Text, "Y", APP_ID)
                Else
                    adoDS = svcHRIS.GetRPTEmpSalary(txtEmployeeId.Text, "N", APP_ID)
                End If
            Else
                adoDS = svcHRIS.GetRPTEmpSalary("", "Y", APP_ID)
            End If
    ...
    Private Sub Generate_Report(ByVal adoDS As DataSet)
        ...
        Try
            ...
            strTemplate = Application.StartupPath & "\Reports\EMPLOYEE_SALARY.xls"
            ...
            intNou = 0
            strEmployeeId = ""
            For Each adoRow In adoDS.Tables("EMPSALARY").Rows
