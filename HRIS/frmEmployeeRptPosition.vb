Public Class frmEmployeeRptPosition
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmEmployeeRptPosition))
        ...
        Me.chkHistory.Location = New System.Drawing.Point(448, 91)
        ...
        Me.Name = "frmEmployeeRptPosition"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Employee Position Information - Report"
...
#End Region
        ...
        Try
            ...
            If rbtEach.Checked Then
                ...
                If chkHistory.Checked Then
                    adoDS = svcHRIS.GetRPTEmpPosition(txtEmployeeId.Text, "Y", APP_ID)
                Else
                    adoDS = svcHRIS.GetRPTEmpPosition(txtEmployeeId.Text, "N", APP_ID)
                End If
            Else
                adoDS = svcHRIS.GetRPTEmpPosition("", "Y", APP_ID)
            End If
    ...
    Private Sub Generate_Report(ByVal adoDS As DataSet)
        ...
        Try
            ...
            strTemplate = Application.StartupPath & "\Reports\EMPLOYEE_POSITION.xls"
            ...
            xlWs.Cells(4, 9) = "Print Time: " & Format(Now, "HH:mm tt")
            I = 6
            intNou = 0
            strEmployeeId = ""
            For Each adoRow In adoDS.Tables("EMPPOSITION").Rows
                ...
                xlWs.Cells(I, 4) = adoRow!POSITION_ID
                xlWs.Cells(I, 5) = adoRow!POSITION_NAME
                xlWs.Cells(I, 6) = Format(adoRow!EFFECTIVE_DATE, "dd MMM yyyy")
                If Not IsDBNull(adoRow!END_DATE) Then
                    xlWs.Cells(I, 7) = Format(adoRow!END_DATE, "dd MMM yyyy")
                End If
                xlWs.Cells(I, 8) = adoRow!RESOURCE_DESC
                xlWs.Cells(I, 9) = adoRow!COMMENT
