Public Class frmEmployeeRptPerformance
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmEmployeeRptPerformance))
        ...
        Me.rbtAll.Location = New System.Drawing.Point(216, 48)
        ...
        Me.rbtEach.Location = New System.Drawing.Point(40, 48)
        ...
        Me.chkHistory.Location = New System.Drawing.Point(449, 88)
        Me.chkHistory.Name = "chkHistory"
        Me.chkHistory.Size = New System.Drawing.Size(128, 16)
        ...
        Me.Name = "frmEmployeeRptPerformance"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Employee Performance Information - Report"
...
#End Region
        ...
        Try
            ...
            If rbtEach.Checked Then
                ...
                If chkHistory.Checked Then
                    adoDS = svcHRIS.GetRPTEmpNote(txtEmployeeId.Text, "Y", APP_ID)
                Else
                    adoDS = svcHRIS.GetRPTEmpNote(txtEmployeeId.Text, "N", APP_ID)
                End If
            Else
                adoDS = svcHRIS.GetRPTEmpNote("", "Y", APP_ID)
            End If
    ...
    Private Sub Generate_Report(ByVal adoDS As DataSet)
        ...
        Try
            ...
            strTemplate = Application.StartupPath & "\Reports\EMPLOYEE_PERFORMANCE.xls"
            ...
            xlWs.Cells(4, 7) = "Print Time: " & Format(Now, "HH:mm tt")
            I = 6
            intNou = 0
            strEmployeeId = ""
            For Each adoRow In adoDS.Tables("EMPNOTE").Rows
                ...
                xlWs.Cells(I, 4) = Format(adoRow!ENTRY_DATE, "dd MMM yyyy")
                xlWs.Cells(I, 5) = adoRow!POSITION_ID
                xlWs.Cells(I, 6) = adoRow!POSITION_NAME
                xlWs.Cells(I, 7) = adoRow!COMMENT
            ...
            I = I + 1
            xlWs.Range(xlWs.Cells(I, 1), xlWs.Cells(I, 7)).Borders(Excel.XlBordersIndex.xlEdgeTop).Weight = Excel.XlBorderWeight.xlThin

            I = I + 1
            xlWs.Cells(I, 1) = "OOOooo End Of Report oooOOO"
            xlWs.Range(xlWs.Cells(I, 1), xlWs.Cells(I, 7)).Merge()
