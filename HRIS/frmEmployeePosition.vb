...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmEmployeePosition))
        ...
        'GroupBox1
        '
        Me.GroupBox1.Controls.AddRange(New System.Windows.Forms.Control() {Me.lblActiveStatus, Me.lblTitleActive, Me.txtEmployeeId, Me.btnSelect, Me.lblEmployeeName, Me.Label1, Me.Label4})
        ...
        Me.lblActiveStatus.Location = New System.Drawing.Point(117, 79)
        ...
        Me.lblTitleActive.Location = New System.Drawing.Point(44, 79)
        ...
        Me.txtEmployeeId.Location = New System.Drawing.Point(118, 51)
        ...
        Me.btnSelect.Location = New System.Drawing.Point(496, 66)
        ...
        Me.lblEmployeeName.Location = New System.Drawing.Point(203, 54)
        ...
        Me.Label4.Location = New System.Drawing.Point(49, 54)
        ...
        Me.GroupBox2.Text = "Employee Position Information"
        '
        'lvwList
        '
        ...
        'ColumnHeader4
        '
        Me.ColumnHeader4.Text = "Effective Date"
        ...
        'ColumnHeader7
        '
        Me.ColumnHeader7.Text = "RecordId"
        ...
        Me.Text = "Review Employee Position"
...
#End Region
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        Try
            ...
            System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
            lvwList.Items.Clear()
            myDS = svcHRIS.GetEMPPosition(txtEmployeeId.Text, "", APP_ID)
            If myDS.Tables("EMPPOSITION").Rows.Count > 0 Then
                For Each adoRow In myDS.Tables("EMPPOSITION").Rows
                    ...
                    End If
                    objItem.SubItems.Add(adoRow!REASON)
                    objItem.SubItems.Add(adoRow!RECORD_ID)
                    objItem.Selected = True
                Next
            Else
                System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                MessageBox.Show("Employee Position data are not found!", APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
    ...
    Private Sub btnAddNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        Dim svcHRIS As New HRIS.svcHRIS()
        Dim myForm As New frmEmployeePosition01()
        Dim adoRow As DataRow
        Dim myDS As New DataSet()
        Dim objItem As ListViewItem
...
Form_Loop:
            ...
            If myForm.GetCancelStatus = False Then
                ...
                strResult = svcHRIS.AddNewEMPPosition(myDS, APP_ID)
                If strResult <> "" Then
                    System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                    MessageBox.Show(strResult, APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
                    GoTo Form_Loop
                Else
                    strEmployeeId = myDS.Tables("EMPPOSITION").Rows(0)("EMPLOYEE_ID")
                    strPosition = myDS.Tables("EMPPOSITION").Rows(0)("POSITION_ID")
                    myDS.Dispose()

                    myDS = svcHRIS.GetEMPPosition(strEmployeeId, strPosition, APP_ID)
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        ...
        Try
            ...
            strReason = lvwList.SelectedItems.Item(0).SubItems(5).Text
            System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
            myDS = svcHRIS.GetEMPPosition(txtEmployeeId.Text, strPositionId, APP_ID)

            myForm.Initialize(blnAddNew, strPositionId, strReason, txtEmployeeId.Text, lblEmployeeName.Text)
...
Form_Loop:
            ...
            If myForm.GetCancelStatus = False Then
                System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
                myDS = myForm.GetDataSet()
                svcHRIS.UpdateEMPPosition(myDS, APP_ID)

                strPositionId = myDS.Tables("EMPPOSITION").Rows(lngRow)("POSITION_ID")
                myDS.Dispose()

                myDS = svcHRIS.GetEMPPosition(txtEmployeeId.Text, strPositionId, APP_ID)
                For Each adoRow In myDS.Tables("EMPPOSITION").Rows
                    lvwList.SelectedItems.Item(0).SubItems(1).Text = CStr(adoRow!POSITION_ID)
                    lvwList.SelectedItems.Item(0).SubItems(2).Text = CStr(adoRow!POSITION_NAME)
                    lvwList.SelectedItems.Item(0).SubItems(3).Text = Format(adoRow!EFFECTIVE_DATE, "dd MMM yyyy")
                    If Not IsDBNull(adoRow!END_DATE) Then
                        lvwList.SelectedItems.Item(0).SubItems(4).Text = Format(adoRow!END_DATE, "dd MMM yyyy")
                    End If
                    lvwList.SelectedItems.Item(0).SubItems(5).Text = CStr(adoRow!REASON)
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            ...
            If MessageBox.Show("Are you sure want to delete this Employee Data?", APP_NAME, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                ...
                svcHRIS.DeleteEMPPosition(txtEmployeeId.Text, lvwList.SelectedItems.Item(0).SubItems(1).Text, APP_ID)
