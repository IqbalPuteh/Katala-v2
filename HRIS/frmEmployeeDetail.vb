...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmEmployeeDetail))
        ...
        Me.txtEmployeeId.Location = New System.Drawing.Point(120, 51)
        ...
        Me.lblEmployeeName.Location = New System.Drawing.Point(206, 54)
        ...
        Me.GroupBox2.Text = "Employee Detail Information"
        '
        'lvwList
        '
        Me.lvwList.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(255, Byte), CType(192, Byte))
        Me.lvwList.Columns.AddRange(New System.Windows.Forms.ColumnHeader() {Me.ColumnHeader1, Me.ColumnHeader2, Me.ColumnHeader3, Me.ColumnHeader4, Me.ColumnHeader5, Me.ColumnHeader6, Me.ColumnHeader7})
        ...
        Me.lvwList.Size = New System.Drawing.Size(594, 252)
        ...
        'ColumnHeader4
        '
        Me.ColumnHeader4.Text = "Dependants"
        Me.ColumnHeader4.Width = 100
        '
        'ColumnHeader5
        '
        Me.ColumnHeader5.Text = "Hire Date"
        Me.ColumnHeader5.Width = 105
        '
        'ColumnHeader6
        '
        Me.ColumnHeader6.Text = "Retire Date"
        Me.ColumnHeader6.Width = 100
        '
        'ColumnHeader7
        '
        Me.ColumnHeader7.Text = "Record Id"
        ...
        Me.Name = "frmEmployeeDetail"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Review Employee Detail Information"
...
#End Region
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        Try
            ...
            lvwList.Items.Clear()
            myDS = svcHRIS.GetEmpDetail(txtEmployeeId.Text, "", APP_ID)
            If myDS.Tables("EMPDETAIL").Rows.Count > 0 Then
                For Each adoRow In myDS.Tables("EMPDETAIL").Rows
                    objItem = New ListViewItem(lvwList.Items.Count + 1)
                    lvwList.Items.Add(objItem)
                    If adoRow!GENDER = "M" Then
                        objItem.SubItems.Add("Male")
                    Else
                        objItem.SubItems.Add("Female")
                    End If
                    If adoRow!MARITAL_STATUS = "S" Then
                        objItem.SubItems.Add("Single")
                    ElseIf adoRow!MARITAL_STATUS = "M" Then
                        objItem.SubItems.Add("Married")
                    Else
                        objItem.SubItems.Add("Widow")
                    End If
                    objItem.SubItems.Add(adoRow!DEPENDANTS)
                    objItem.SubItems.Add(Format(adoRow!HIRE_DATE, "dd MMM yyyy"))
                    If Not IsDBNull(adoRow!RETIRE_DATE) Then
                        objItem.SubItems.Add(Format(adoRow!RETIRE_DATE, "dd MMM yyyy"))
                    Else
                        objItem.SubItems.Add("")
                    End If
                    objItem.SubItems.Add(CStr(adoRow!RECORD_ID))
                    objItem.Selected = True
                Next
            Else
                System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                MessageBox.Show("Employee Detail data are not found!", APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        Dim svcHRIS As New HRIS.svcHRIS()
        Dim myForm As New frmEmployeeDetail01()
        ...
        Try
            ...
            If adoDS.Tables("EMPINFO").Rows.Count = 0 Then
                System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                MessageBox.Show("Employee Detail data not found!", APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            ...
            adoDS = svcHRIS.GetEmpDetail(txtEmployeeId.Text, lvwList.SelectedItems.Item(0).SubItems(6).Text, APP_ID)
...
Form_Loop:
            ...
            If myForm.GetCancelStatus = False Then
                ...
                svcHRIS.UpdateEmpDetail(adoDS, APP_ID)
                adoRow = adoDS.Tables("EMPLOYEEDETAIL").Rows(0)

                If adoRow!GENDER = "M" Then
                    lvwList.SelectedItems.Item(0).SubItems(1).Text = "Male"
                Else
                    lvwList.SelectedItems.Item(0).SubItems(1).Text = "Female"
                End If
                If adoRow!MARITAL_STATUS = "S" Then
                    lvwList.SelectedItems.Item(0).SubItems(2).Text = "Single"
                ElseIf adoRow!MARITAL_STATUS = "M" Then
                    lvwList.SelectedItems.Item(0).SubItems(2).Text = "Married"
                Else
                    lvwList.SelectedItems.Item(0).SubItems(2).Text = "Widow"
                End If
                lvwList.SelectedItems.Item(0).SubItems(3).Text = adoRow!DEPENDANTS
                lvwList.SelectedItems.Item(0).SubItems(4).Text = Format(adoRow!HIRE_DATE, "dd MMM yyyy")
                If Not IsDBNull(adoRow!RETIRE_DATE) Then
                    lvwList.SelectedItems.Item(0).SubItems(5).Text = Format(adoRow!RETIRE_DATE, "dd MMM yyyy")
                Else
                    lvwList.SelectedItems.Item(0).SubItems(5).Text = ""
                End If
                lvwList.SelectedItems.Item(0).SubItems(6).Text = CStr(adoRow!RECORD_ID)
        ...
        Try
            ...
            If MessageBox.Show("Are you sure want to delete this Employee Data?", APP_NAME, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                ...
                If adoDS.Tables("LATEMPDETAIL").Rows.Count > 0 Then
                    strRecordId = lvwList.SelectedItems.Item(0).SubItems(6).Text
                    If strRecordId <> CStr(adoDS.Tables("LATEMPDETAIL").Rows(0)("RECORD_ID")) Then
                        System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                        MessageBox.Show("Employee Detail history can not be delete!", APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Exit Sub
                    End If
                    ...
                    End If
                End If
                svcHRIS.DeleteEmpDetail(txtEmployeeId.Text, lvwList.SelectedItems.Item(0).SubItems(6).Text, APP_ID)
...
Form_Loop:
            ...
            If myForm.GetCancelStatus = False Then
                System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
                adoDS = myForm.GetDataSet()
                strResult = svcHRIS.AddNewEmpDetail(adoDS, APP_ID)
                If strResult <> "" Then
                    System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                ...
                Else
                    adoDS.Dispose()
                    adoDS = svcHRIS.GetLatestEMPDetail(txtEmployeeId.Text, APP_ID)
                    adoRow = adoDS.Tables("LATEMPDETAIL").Rows(0)
