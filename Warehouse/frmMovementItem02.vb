Public Class frmMovementItem02
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtMoveQTY As System.Windows.Forms.NumericUpDown
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmMovementItem02))
        Me.btnInput = New System.Windows.Forms.Button
        Me.btnCancel = New System.Windows.Forms.Button
        Me.grpStock = New System.Windows.Forms.GroupBox
        Me.txtMoveQTY = New System.Windows.Forms.NumericUpDown
        ...
        CType(Me.txtMoveQTY, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txtStockQTY, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'btnInput
        '
        Me.btnInput.Location = New System.Drawing.Point(399, 282)
        ...
        'btnCancel
        '
        Me.btnCancel.Location = New System.Drawing.Point(487, 282)
        ...
        'grpStock
        '
        Me.grpStock.Controls.Add(Me.txtMoveQTY)
        ...
        Me.grpStock.TabIndex = 27
        Me.grpStock.TabStop = False
        Me.grpStock.Text = "Stock Item Detail Information"
        '
        'txtMoveQTY
        '
        Me.txtMoveQTY.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(255, Byte), CType(192, Byte))
        Me.txtMoveQTY.Location = New System.Drawing.Point(72, 131)
        Me.txtMoveQTY.Maximum = New Decimal(New Integer() {1000000, 0, 0, 0})
        Me.txtMoveQTY.Minimum = New Decimal(New Integer() {1, 0, 0, 0})
        Me.txtMoveQTY.Name = "txtMoveQTY"
        Me.txtMoveQTY.Size = New System.Drawing.Size(54, 21)
        Me.txtMoveQTY.TabIndex = 91
        Me.txtMoveQTY.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        Me.txtMoveQTY.Value = New Decimal(New Integer() {1, 0, 0, 0})
        '
        'Label4
        '
        ...
        Me.Label5.Location = New System.Drawing.Point(255, 32)
        ...
        Me.Name = "frmMovementItem02"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Input Item Information"
        Me.grpStock.ResumeLayout(False)
        CType(Me.txtMoveQTY, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private Sub txtItemNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtItemNo.KeyDown
        ...
        Try
            If e.KeyCode = e.KeyCode.F2 Then
                myForm.Initialize(txtItemNo.Text, adoDSItemStock, "ITEMSTOCKLOV")
...
Form_Loop:
                ...
                If myForm.GetCancelStatus = False Then
                    ...
                    If adoDS.Tables("RESOURCEINFO").Rows.Count > 0 Then
                        ...
                        adoDS = svcWarehouse.GetStockItem(txtItemNo.Text, APP_ID)
                        If adoDS.Tables("STOCK_ITEM").Rows.Count > 0 Then
                            adoRow = adoDS.Tables("STOCK_ITEM").Rows(0)
    ...
    Private Sub frmMovementItem02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim svcWarehouse As New Warehouse.svcWarehouse()
        ...
        Try
            ...
            If blnAddNew Then
                adoDSItemStock = svcWarehouse.GetItemStockLOV("", APP_ID)
            Else
    ...
    Private Sub frmMovementItem02_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        txtItemNo.Focus()
    End Sub
    ...
    Private Sub FillDataSet(ByRef adoDS As DataSet)
        ...
        Try
            ...
            adoDataRow("MOVE_QTY") = txtMoveQTY.Text
    ...
    Private Function CreateResourceCodeRs() As DataSet
        ...
        Try
            ...
            adoColumn = New DataColumn("MOVE_QTY")
            adoColumn.DataType = System.Type.GetType("System.String")
            adoDS.Tables("INPUTITEM").Columns.Add(adoColumn)
    ...
    Private Sub btnInput_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInput.Click
        ...
        If ValidateEmptyField(cboStockWarehouse) Then
            Exit Sub
        End If
        If txtStockQTY.Text = 0 Then
            MessageBox.Show("Sorry you can not move the item, becasue the stock is 0. ", APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
        If txtMoveQTY.Value > txtStockQTY.Value Then
            MessageBox.Show("The Move QTY must be less or similar than Stock QTY. ", APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
    ...
    Private Sub txtMoveQTY_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMoveQTY.Enter
        txtMoveQTY.Select(0, txtMoveQTY.Text.Length)
    End Sub
End Class
