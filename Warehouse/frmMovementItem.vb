...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmMovementItem))
        ...
        Me.lblItemName.Location = New System.Drawing.Point(253, 80)
        ...
        Me.lblTransDate.Location = New System.Drawing.Point(32, 53)
        ...
        'btnClose
        '
        Me.btnClose.Location = New System.Drawing.Point(558, 396)
        ...
        Me.GroupBox2.Text = "Movement Item Information"
        '
        'lvwList
        '
        ...
        'ColumnHeader2
        '
        Me.ColumnHeader2.Text = "Moved Date"
        Me.ColumnHeader2.Width = 170
        '
        'ColumnHeader3
        '
        Me.ColumnHeader3.Text = "Move By"
        ...
        Me.Name = "frmMovementItem"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Review Movement Item Information"
...
Form_Loop:
    ...
    Private Sub frmMovementItem_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        Try
            ...
            If Trim(txtItemCode.Text) <> "" And lblItemName.Text = "" Then
                ...
                Exit Sub
            End If
            If Format(dtpEndDate.Value, "dd/MM/yyyy") < Format(dtpStartDate.Value, "dd/MM/yyyy") Then
            ...
            Else
                strEndDate = ""
            End If
            myDS = svcWarehouse.GetMovementItem(txtItemCode.Text, strStartDate, strEndDate, APP_ID)
            If myDS.Tables("MOVEMENT").Rows.Count > 0 Then
                For Each adoRow In myDS.Tables("MOVEMENT").Rows
                    objItem = New ListViewItem(lvwList.Items.Count + 1)
                    lvwList.Items.Add(objItem)
                    objItem.SubItems.Add(Format(adoRow!MOV_DATE, "dd-MMM-yy"))
                    objItem.SubItems.Add(adoRow!MOV_BY)
                    objItem.SubItems.Add(adoRow!WAREHOUSE_NAME)
                    objItem.SubItems.Add(adoRow!MOV_ID)
                    objItem.Selected = True
                Next
            Else
                System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                MessageBox.Show("Movement Item data are not found!", APP_NAME, MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
    ...
    Private Sub btnAddNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddNew.Click
        ...
        Dim objItem As ListViewItem
        Dim strResult As String
        Dim myForm As New frmMovementItem01()
        Dim adoRow As DataRow
        Dim intMaxMovId As Integer
...
Form_Loop:
            ...
            If myForm.GetCancelStatus = False Then
                ...
                strResult = svcWarehouse.AddMoveItem(adoDSHeader, adoDSDetail, APP_ID)
                If strResult <> "" Then
                    System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
                ...
                Else
                    ...
                    intMaxMovId = svcWarehouse.GetMaxMovId(adoRow!MOV_DATE, "", APP_ID)
                    If intMaxMovId > 0 Then
                        adoDSHeader.Dispose()
                        adoDSHeader = svcWarehouse.GetMovement(intMaxMovId, APP_ID)
                        adoRow = adoDSHeader.Tables("MOVEMENT").Rows(0)
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        ...
        Try
            ...
            System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.WaitCursor
            adoDSHeader = svcWarehouse.GetMoveHeader(lvwList.SelectedItems.Item(0).SubItems(4).Text, APP_ID)
            adoDSDetail = svcWarehouse.GetMoveDetail(lvwList.SelectedItems.Item(0).SubItems(4).Text, APP_ID)
...
Form_Loop:
            ...
            If myForm.GetCancelStatus = False Then
                ...
                svcWarehouse.UpdateMovement(adoDSHeader, adoDSDetail, APP_ID)
                adoRow = adoDSHeader.Tables("MOVE_ITEM").Rows(0)
                lvwList.SelectedItems.Item(0).SubItems(1).Text = Format(adoRow!MOV_DATE, "dd-MMM-yy")
                lvwList.SelectedItems.Item(0).SubItems(2).Text = adoRow!MOV_BY
                btnSelect.Enabled = True
                adoDSHeader.Dispose()
            End If
            System.Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    ...
    Private Sub btnReports_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReports.Click
        Dim myForm As New frmMovementItemRpt
