Public Class frmMembershipRptMonthlyIntrestPay
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmMembershipRptMonthlyIntrestPay))
        ...
        '
        'frmMembershipRptMonthlyIntrestPay
        '
        ...
        Me.Name = "frmMembershipRptMonthlyIntrestPay"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Monthly Intrest Payment"
...
#End Region
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        Try
            ...
            adoDS = svcMembership.GetMonthlyIntrestPayment(Format(dtpDate.Value, "yyyyMM"), APP_ID)
    ...
    Private Sub Generate_Report(ByVal adoDS As DataSet)
        ...
        Try
            ...
            strTemplate = Application.StartupPath & "\Reports\MEMBER_MONTHLYINTRESTPAY.xls"
            ...
            For Each adoRow In adoDS.Tables(0).Rows
                ...
                '* Code by Macho DeGanteng, 2007 March 04 *'
                'I = I + 1
                strMemberId = adoRow!MEMBERSHIP_NO
                xlWs.Cells(I, 1) = CInt(intNou) & "."
                xlWs.Cells(I, 2) = NullToString(adoRow!MEMBERSHIP_NO)
            ...
            '* Code by Macho DeGanteng, 2009 Aug 21 *'
            ...
            intTransactionCount = 0
            intFirstBalance = 0
            For Each adoRow In adoDS.Tables(1).Rows
                strMemberId = adoRow!MEMBERSHIP_NO
                xlWs.Cells(I, 1) = CInt(intNou) & "."
                xlWs.Cells(I, 2) = NullToString(adoRow!MEMBERSHIP_NO)
                xlWs.Cells(I, 3) = NullToString(adoRow!FIRST_NAME) & " " & NullToString(adoRow!FAMILY_NAME)
